...
public class EmployeeController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<EmployeeModel> updateEmployeeById(@PathVariable Long id, @RequestBody EmployeeModel employeeModel){
	...
	@PatchMapping("/{id}")
	public ResponseEntity<EmployeeModel> patchUpdateEmployee(@PathVariable Long id, @RequestBody EmployeeModel employeeModel){
